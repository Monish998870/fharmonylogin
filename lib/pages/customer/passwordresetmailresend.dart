...
class PasswordResetResentPage extends StatefulWidget {
  ...
  @override
  _PasswordResetResentPageState createState() => _PasswordResetResentPageState();
}

class _PasswordResetResentPageState extends State<PasswordResetResentPage> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Image.asset(
                'assets/images/mailsent.png',// Replace with your image URL or asset
                height: 150,
              ),
            ),
            SizedBox(height: 30),
